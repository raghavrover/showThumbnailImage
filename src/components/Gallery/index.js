...
class Gallery extends Component {
  ...
  getBgImage = eachObj => {
    this.setState({imageUrl: eachObj.imageUrl})
    this.setState({altText: eachObj.imageAltText})
    this.setState({id: eachObj.id})
  }

  render() {
    const {imageUrl, altText, id} = this.state
